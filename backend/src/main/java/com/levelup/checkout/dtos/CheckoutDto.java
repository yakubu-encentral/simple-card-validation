...
public class CheckoutDto {
    ...
    @Pattern(regexp="\\d{2}", message = "Invalid Expiry Month: Must be of 2 digits long")
    private String expiryMonth;

    @NotBlank(message = "Invalid Card Expiry Year: Not provided")
    @Pattern(regexp="\\d{2}", message = "Invalid Card Expiry Year: Must be of 2 digits long")
    private String expiryYear;

    @NotBlank(message = "Invalid Card CVV/CVC: Not provided")
    @Pattern(regexp="\\d{3,4}", message = "Invalid Card CVV/CVC: Must be of 3 or 4 digits long")
    private String ccv;
